                    ...
                    <View style={{flexDirection:'column', height:'100%'}}>
                        ...
                        <ScrollView ref={thisRef => this.stopsList = thisRef}
                            ...
                            <Text onLayout={this.measureJourney} style={{padding:0, color: '#fff'}}>{
                                !departure.stops ? <Text/> : departure.stops.map(stop => (<Text key={stop} style={{fontSize: baseFontSize, lineHeight: baseFontSize * 3}}> {stop} <Text style={styles.yellowBullet}>•</Text></Text>))
                            }</Text></ScrollView>}
                    </View>
                </TouchableHighlight>
            </View>
